  ...
  useEffect(() => {
    ...
    async function getPlantoes() {
      ...
      for (let i = 0; i < resp.data.length; i++) {
        ...
        resp.data[i]["num_atendimentos"] =
          resp.data[i]["num_atendimentos"] - resp.data[i]["Consulta"].length;
      }
  ...
  return (
    <div className="d-flex justify-content-center flex-column">
      ...
      <div className="container d-flex flex-row flex-wrap">
          ...
          plantoes.map((plantao) => (
            ...
            >
              ...
              <div className="card-body">
                <h5 className="card-title">{`Dia ${plantao[
                  "data"
                ].getDate()} do ${plantao["data"].getMonth() + 1}`}</h5>
                ...
                <p className="card-text">
                  <b>Vagas</b>
                  {`:${plantao["num_atendimentos"]}`}
                </p>
                <button
                  onClick={() =>
                    handleConsulta(plantao["data"], plantao["medico_crm"])
                  }
                  href="#"
        ...
        {!plantoes && <h3>Nenhum plantão encontrado</h3>}
