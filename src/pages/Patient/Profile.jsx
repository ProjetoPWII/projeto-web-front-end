...
function Profile() {
  ...
  const containerClassNameName = isDarkMode ? "dark-container" : "";
 ...
 const defaultProfile = "https://t4.ftcdn.net/jpg/02/29/75/83/360_F_229758328_7x8jwCwjtBMmC6rgFzLFhZoEpLobB6L8.jpg"
  ...
  return (
    <div className={`${containerClassNameName}`}>
      {user ? (
        <>
            ...
            <div className="container py-5 h-100">
              <div className="row d-flex justify-content-center align-items-center h-100">
                <div className="col col-lg-9 col-xl-7">
                  <div className="card">
                    <div className="rounded-top  d-flex flex-row" style={{ backgroundColor: "#000;", height: "200px;" }}>
                    ...
                    <div className="p-4 text-black" style={{ backgroundColor: "#f8f9fa;" }}>
                      <div className="d-flex justify-content-end text-center py-1">
                        <div>
                          ...
                          <p className="small text-muted mb-0">{user.nome}</p>
                        </div>
                        <div className="px-3">
                          <p className="mb-1 h5">Sexo</p>
                          <p className="small text-muted mb-0">{user.sexo}</p>
                        </div>
                        <div>
                          <p className="mb-1 h5">Idade</p>
                          <p className="small text-muted mb-0">{user.idade}</p>
                        </div>
                      </div>
                    </div>
                    <div className="card-body p-4 text-black">
                      <div className="mb-5">
                        ...
                        <div className="p-4" style={{ backgroundColor: "#f8f9fa;" }}>
                          <p className="font-italic mb-1"><b>Cidade</b>:{user.endereco.cidade}</p>
                          <p className="font-italic mb-1"><b>Estado</b>: {user.endereco.estado}</p>
                          <p className="font-italic mb-0"><b>Bairro</b>:{user.endereco.bairro}</p>
                        </div>
                      </div>
                        ...
                        {user && (
                          ...
                          consultas.map((consulta) => (
                            ...
                            <div onClick={() => getConsulta(consulta['id'])} key={consulta['data_plantao']} className="card m-2 bg-dark text-white"
                              style={{
                                width: "16rem", boxShadow: "13px 16px 14px 0px rgba(0, 0, 0, 0.3)", cursor: 'pointer'
                              }}>
