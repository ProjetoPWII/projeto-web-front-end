            ...
            <form onSubmit={handleSignUp} className='container d-flex flex-column' encType="multipart/form-data">
                ...
                <div className="row">
                    ...
                    <div className="col-xl-6 col-sm-12 p-3">
                        ...
                        <input onChange={(e) => setSexo("Masculino")} value="Masculino" type="radio" className="btn-check" name="gender" id="male" autoComplete="off" required />
                        <label style={{ marginLeft: 12 }} className="btn btn-sm btn-outline-secondary" htmlFor="male">Masculino</label>

                        <input onChange={(e) => setSexo("Feminino")} value="Feminino" type="radio" className="btn-check ml-6" name="gender" id="female" autoComplete="off" required />
